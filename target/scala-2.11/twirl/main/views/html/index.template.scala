            ...
            <div class="row" style="background-color: #1b6d85">
                ...
                <div class="col-sm-6 col-md-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Endereco: """),_display_(/*47.64*/(usuario.getDistrict())),format.raw/*47.87*/("""</li>
